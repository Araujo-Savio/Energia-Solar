...
namespace SolarEnergy.Controllers
{
    ...
    public class AdminController : Controller
    {
        ...
        private static bool IsPendingStatus(string? status) => StatusIsOneOf(status, "Pendente", "Em Análise", "Em Analise");
        private static bool IsRespondedStatus(string? status) => StatusIsOneOf(status, "Respondido", "Proposta Enviada", "Em Negociação", "Em Negociacao");
        private static bool IsAcceptedStatus(string? status) => StatusIsOneOf(status, "Aceito", "Aceita", "Concluído", "Concluido", "Completed");
        private static bool IsAcceptedProposalStatus(string? status) => StatusIsOneOf(status, "Accepted", "Aceito", "Aceita", "Concluído", "Concluido");
    }
}